...
import Animated, { and, call, cond, eq, Extrapolate, neq, not, set } from 'react-native-reanimated';
import isEqual from 'lodash.isequal';
import { useValue } from 'react-native-redash';
import { useBottomSheet } from '../../hooks/useBottomSheet';
import { DEFAULT_OPACITY, DEFAULT_APPEARS_ON_INDEX, DEFAULT_DISAPPEARS_ON_INDEX, DEFAULT_ENABLE_TOUCH_THROUGH, DEFAULT_CLOSE_ON_PRESS } from './constants';
...
const BottomSheetBackdropComponent = ({
  ...
  return closeOnPress ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(AnimatedTouchableWithoutFeedback, {
    accessible: true,
  ...
  })), /*#__PURE__*/React.createElement(Animated.Code, null, () => cond(and(eq(animatedPosition, disappearsOnIndex), isTouchable), [set(isTouchable, 0), call([], () => {
    // @ts-ignore
    containerRef.current.setNativeProps({
      pointerEvents: 'none'
    });
  })], cond(and(neq(animatedPosition, disappearsOnIndex), not(isTouchable)), [set(isTouchable, 1), call([], () => {
    // @ts-ignore
    containerRef.current.setNativeProps({
      pointerEvents: 'auto'
    });
