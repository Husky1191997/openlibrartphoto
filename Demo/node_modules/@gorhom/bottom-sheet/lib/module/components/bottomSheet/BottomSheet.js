...
const BottomSheetComponent = /*#__PURE__*/forwardRef((props, ref) => {
  ...
  const safeHandleHeight = useMemo(() => handleHeight || DEFAULT_HANDLE_HEIGHT, [handleHeight]);
  ...
  const shouldMeasureHandleHeight = useMemo(() => _providedHandleHeight === undefined && backgroundComponent !== undefined, [_providedHandleHeight, backgroundComponent]); // refs
  ...
  const animatedPosition = useMemo(() => abs(sub(safeContainerHeight, position)), [safeContainerHeight, position]);
  /**
  ...
  }, handlePanGestureHandler)), /*#__PURE__*/React.createElement(BottomSheetDraggableView, {
