...
const BottomSheetComponent = /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
  ...
  const safeHandleHeight = (0, _react.useMemo)(() => handleHeight || _constants2.DEFAULT_HANDLE_HEIGHT, [handleHeight]);
  ...
  const shouldMeasureHandleHeight = (0, _react.useMemo)(() => _providedHandleHeight === undefined && backgroundComponent !== undefined, [_providedHandleHeight, backgroundComponent]); // refs
  ...
  const animatedPosition = (0, _react.useMemo)(() => (0, _reactNativeReanimated.abs)((0, _reactNativeReanimated.sub)(safeContainerHeight, position)), [safeContainerHeight, position]);
  /**
  ...
  (0, _react.useLayoutEffect)(() => {
    if (animateOnMount && isLayoutCalculated && didMountOnAnimate.current === false) {
  ...
  }, handlePanGestureHandler)), /*#__PURE__*/_react.default.createElement(_bottomSheetDraggableView.default, {
