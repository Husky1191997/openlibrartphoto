...
const CustomKeyboardViewNativeAndroid = requireNativeComponent(
  'CustomKeyboardViewNative',
);
...
export default class CustomKeyboardView extends Component {
    ...
    if (IsIOS && TextInputKeyboardManagerIOS) {
      KeyboardRegistry.addListener('onToggleExpandedKeyboard', (args) => {
        if (this.props.inputRef) {
          ...
          this.keyboardExpandedToggle[args.keyboardId] = !this
            .keyboardExpandedToggle[args.keyboardId];
  ...
  componentWillUnmount() {
    ...
    if (this.props.component) {
      KeyboardRegistry.removeListeners(
        `${this.props.component}.onItemSelected`,
      );
    }
  }
  ...
  render() {
    if (IsAndroid) {
      ...
      const KeyboardComponent =
        component && KeyboardRegistry.getKeyboard(component);
      return (
